...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 w-72 h-full bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out xl:translate-x-0 xl:static xl:z-auto ${
