...
| Tutoría | sí | sí | sí | completo | CASI COMPLETO | P0 | Formalizar acceso por tutor/sección/año y cierre de libreta; guard y validaciones de recurso ya existen. **A:** aparente sí. **D:** Secciones, Staff tutor, Notas, Asistencia, criterios. |
...
| Staff | sí | sí | sí | completo | COMPLETO | P0 | Incremento institucional y pulido visual V1 aceptados: listado híbrido responsive, búsqueda, alta/edición, disponibilidad de citas y creación/asociación de credenciales con membresías. [Contrato y límites](modulos/staff.md), [aceptación funcional](registro-cambios/2026-09-07-staff-identidad-v1.md), [aceptación UX](registro-cambios/2026-09-09-staff-ux-v1.md). **A:** validada en alcance dirigido. **D:** Persona, Usuarios, colegios, secciones. |
...
| Secciones | sí | sí | sí | completo | CASI COMPLETO | P0 | Aceptar cupos, tutor y configuración anual. **A:** aparente sí. **D:** Grados, años, Docentes, Staff. |
